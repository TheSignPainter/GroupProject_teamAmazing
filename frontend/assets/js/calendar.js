...
$.browser = function () {
    ...
    if (msie.test(userAgent)) {
        _browser.ie = true;
        _browser.ver = parseFloat(RegExp["$1"]);
...
L_calendar.prototype={
	...
	CreateHTML:function(){
		...
		stylestr+="body{background:#fff;font-size:12px;margin:0px;padding:0px;text-align:left; font-family:\"宋体\";}\r\n";
...
document.writeln('<iframe id="L_DateLayer" name="L_DateLayer" scrolling="no" frameborder="0" style="position:absolute;width:160px; height:188px;z-index:9999;display:none;"></iframe>');
